...
*Draft v7 — supersedes v6. Trial: applies the 🔴 personal / 🟢 node / 🔵 network color-dot convention (matching the project logo's tilde colors) to key mentions of the three layers, as a readability test before rolling it out across other docs. No content changes from v6.*
