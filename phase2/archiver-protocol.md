...
- **Not a blockchain.** No consensus mechanism, no mining, no distributed trust-minimization — the Archivers/board already know and trust each other, and the self-hosted Forgejo server is trusted infrastructure the group controls. Enforcement is a policy your server checks, not a cryptographic guarantee independent of anyone's goodwill.
