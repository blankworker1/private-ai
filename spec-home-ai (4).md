...
*Draft v19 — supersedes v18. Personal Layer editor changed from Obsidian + GitSync + Save as Local Images (three apps) to GitJournal (one app, native git sync, native image insertion, genuine backlinks) — decided after web clipping was already decoupled from the editor (v18), which removed the one requirement keeping Obsidian's plugin ecosystem necessary. Maintenance profile noted honestly: small-team project, real but modest activity. Compiled from working discussion, [date: 2026-09-15].*
