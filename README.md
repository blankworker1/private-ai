...
| `phase2/hardware-relaybox.md` | Placeholder for the relay box hardware decision — not started, deferred until Track 1 validates. |
...
| `phase2/notes.md` | Running holding-pen for Track 2 decisions/clarifications surfaced early — not yet applied to the actual specs. |
