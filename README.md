...
| File | What it is |
|---|---|
| `local-ai-spec-draft-v13.md` | **Household AI** — private, 5-person family platform. Android-first Personal Layer + shared Ollama/Open-WebUI "Brain." |
| `x-implementation-checklist.md` | Companion to the household spec — 16 open build/decision items, execution detail kept separate from the pitch. |
