...
**Conclusion:** essentially any Android phone or tablet sold since ~2017 meets every software requirement. This is a deliberate property of the design (spec §2), not a coincidence. (Mobile Webviewer no longer appears here — web clipping moved to a decoupled Brain PC service; see spec §2/§5.)
...
- **Android version** — quick check against the §1 floor (Android 7.0+) rather than assuming, particularly on older or budget devices whose OEM may have stopped OS updates early.
...
2. **Add the Obsidian plugin** — Save as Local Images, installed from inside Obsidian's own Community Plugins browser, not the Play Store. (Mobile Webviewer no longer needed — web clipping is now a decoupled Brain PC service.)
...
*v2 — supersedes v1. Removes Mobile Webviewer from requirements and setup steps — web clipping decoupled to a Brain PC service (spec-home-ai.md §2/§5). [date: 2026-09-15]*
