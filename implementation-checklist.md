...
*Companion to spec Draft v19. Item 1's steps and item 13 updated to reference GitJournal rather than Obsidian/GitSync, matching the Personal Layer editor decision. Update the spec's Executive Summary once items are completed here.*
